...
try:
 ...
 with sync_playwright() as p:
  ...
  page.locator('[data-ops-tab=evaluation]').click();expect(page.locator('#ops-content')).to_contain_text('1220');expect(page.locator('#ops-content')).to_contain_text('184');check('loop shows provenance, corpus version and downloadable full cases')
  page.locator('#ops-run-eval').click();expect(page.locator('#ops-content')).to_contain_text('1230 / 1230',timeout=30000);check('entire corpus and historical scenarios run from Operations')
