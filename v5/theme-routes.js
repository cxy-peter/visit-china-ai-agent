...
function match(text){const t=String(text||'');if(/长宁|changning/i.test(t)&&/旅游|游览|路线|行程|citywalk|itinerary|tour|walk|逛|玩/i.test(t))return'changning';if(/二战|淞沪|抗战|四行仓库|金山卫|world war|wwii|battle of shanghai|wartime|sihang/i.test(t)&&/地点|路线|旅游|游览|参观|行程|攻入|tour|site|itinerary|walk|visit|历史/i.test(t))return'wwii-shanghai';return null;}
