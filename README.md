# Visit China AI V6.3 · 连续对话、分项需求与来源运营

本轮修复播报回声与管理员连接流程，仅保留浏览器在线语音；查询期间允许追加细节，新增左侧聊天历史、上海16区基础路线及有日期的沪杭席别/价格比较。来源适用条件采用通用规则，多个需求分别呈现。详见[V6.3验收与使用说明](docs/V6_3_RELEASE.md)。
...
下方为各版本交付历史；其中的索引数量、测试规模、连接与部署说明保留当时口径，当前行为以V6.3说明及最终验收记录为准。
