# Visit China AI V6.2 · 旅行问答、来源运营与问题回放

本轮更新：更耐心的连续语音与自动插话、生成期间补充上下文、JCB适用条件、长宁/抗战纪念地路线导出、Flash/Pro切换、正文60分门槛，以及12,000条新话术全样本Loop。340项程序/接口、168项旧浏览器、24项新界面及18项合成音频检查通过；7轮真实DeepSeek抽样通过。候选召回改善125条、无回归，因线上资料版本变化保留为待复核候选。详见[V6.2验收与使用说明](docs/V6_2_RELEASE.md)。
...
下方为各版本交付历史；其中的索引数量、测试规模、连接与部署说明保留当时口径，当前行为以V6.2说明及最终验收记录为准。
